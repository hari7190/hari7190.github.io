        ...
        init: function () {
            ...
            if (this.options.selectAll && !this.options.single) {
                html.push(
                    ...
                    '<span id="" class="option-label">'+this.options.selectAllDelimiter[0] + this.options.selectAllText + this.options.selectAllDelimiter[1]+'</span>',
                    '</label>',
                    '</li>'
                );
            }
            ...
            if ($elm.is('option')) {
                ...
                if ((this.options.blockSeparator > "") && (this.options.blockSeparator == $elm.val())) {
                    html.push(
                        ...
                        '<span id="" class="option-label">'+text+'</span>',
                        '</label>',
                        '</li>'
                    );
                } else {
